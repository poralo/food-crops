...
class Measurement(Describable):
    ...
    def describe(self):
        return f'Measurement of {self.__value}: année-{self.__year}, période-{self.__timeperiodId}-{self.__timeperiodDescr}, commodity-{self.commodity}, indicator-{self.indicator}'
